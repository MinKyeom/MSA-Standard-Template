...
export const metadata = {
  ...
  alternates: {
    canonical: siteUrlSlash,
    languages: { ko: siteUrlSlash, en: siteUrlSlash, "x-default": siteUrlSlash },
  },
};
...
async function getPopularPosts() {
  try {
    return await fetchPopularPosts(6);
  } catch (error) {
...
export default async function HomePage() {
  ...
  return (
    <div className="homepage-wrapper">
      ...
      {/* 3. Popular Posts (by view count, top 6) */}
