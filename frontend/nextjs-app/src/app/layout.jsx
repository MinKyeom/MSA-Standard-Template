...
export const metadata = {
  ...
  alternates: {
    canonical: siteUrl,
    languages: { ko: siteUrl, en: siteUrl, "x-default": siteUrl },
  },
  openGraph: {
  ...
  icons: {
    icon: [{ url: `${siteUrl}/icon.svg`, type: "image/svg+xml" }, { url: "/icon.svg", type: "image/svg+xml" }],
    apple: [{ url: `${siteUrl}/icon.svg`, type: "image/svg+xml" }, { url: "/icon.svg", type: "image/svg+xml" }],
  },
  category: "technology",
};
