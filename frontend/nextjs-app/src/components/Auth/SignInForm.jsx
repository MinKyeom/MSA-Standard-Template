  ...
  return (
    <div className="auth-form-wrapper">
      ...
      <div className="oauth-buttons">
        <a
          href={authBase ? `${authBase}/auth/oauth2/authorization/google` : "#"}
        ...
        <a
          href={authBase ? `${authBase}/auth/oauth2/authorization/github` : "#"}
        ...
        <a
          href={authBase ? `${authBase}/auth/oauth2/authorization/kakao` : "#"}
