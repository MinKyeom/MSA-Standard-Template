...
public class PostResponse {
    ...
    public static PostResponse fromEntity(Post post) {
        ...
        dto.setDraftSourcePostId(post.getDraftSourcePostId());
        ...
        dto.setCardCoverImageUrl(post.getCardCoverImageUrl());
        dto.setCardCoverVideoUrl(post.getCardCoverVideoUrl());
        return dto;
    }
}